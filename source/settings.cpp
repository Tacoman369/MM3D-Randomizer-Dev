...
//  Option StartingSongOfTime = Option::U8("  Song of Time", { "None",             "Song of Time" }, { "" });
  ...
  Option Keysanity              = Option::U8("Small Keys",         { "Vanilla", "Start With", "Own Dungeon", "Any Dungeon", "Overworld", "Anywhere" }, { smallKeyStartWith, smallKeyVanilla, smallKeyOwnDungeon, smallKeyAnyDungeon, smallKeyOverworld, smallKeyAnywhere },             OptionCategory::Setting, (u8)KeysanitySetting::KEYSANITY_VANILLA);
  Option BossKeysanity          = Option::U8("Boss Keys",          { "Vanilla", "Start With","Own Dungeon", "Any Dungeon", "Overworld", "Anywhere" }, { bossKeyStartWith, bossKeyVanilla, bossKeyOwnDungeon, bossKeyAnyDungeon, bossKeyOverworld, bossKeyAnywhere },                   OptionCategory::Setting, (u8)BossKeysanitySetting::BOSSKEYSANITY_VANILLA);
