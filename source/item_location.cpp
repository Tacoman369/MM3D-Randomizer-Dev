...
void LocationTable_Init() {
 ...
 //Ikana Graveyard
 locationTable[IKANA_GRAVEYARD_DAMPE_DIGGING]                      = ItemLocation::Chest      (0x30, 0x00, false, "IG Dampe Digging",                                         IKANA_GRAVEYARD_DAMPE_DIGGING,                  EMPTY_BOTTLE2,                {Category::cIkanaGraveyard, Category::cMinigame,Category::cDayOne},                                                                                                    SpoilerCollectionCheckGroup::GROUP_IKANA_GRAVEYARD );
