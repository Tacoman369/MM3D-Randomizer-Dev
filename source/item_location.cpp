...
void LocationTable_Init() {
 ...
 //Romani Ranch
 locationTable[ROMANI_RANCH_ALIEN_DEFENSE]                         = ItemLocation::Base       (0x35, 0x60, true,  "RR Alien Defense",                                         ROMANI_RANCH_ALIEN_DEFENSE,                     BOTTLE_WITH_MILK,             {Category::cRomaniRanch, Category::cMainInventory},                                                                        SpoilerCollectionCheck::ItemGetInf(0),      SpoilerCollectionCheckGroup::GROUP_ROMANI_RANCH );
