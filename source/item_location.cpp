...
void LocationTable_Init() {
 ...
 locationTable[TINGLE_TWIN_ISLANDS_RR]                             = ItemLocation::Base       (0x5D, 0xB7, false, "TI Tingle Milk Road Buy",                                  TINGLE_TWIN_ISLANDS_RR,                         ROMANI_RANCH_MAP,             {Category::cTwinIslands, Category::cTingleMap, Category::cDayOne},                                                         SpoilerCollectionCheck::ItemGetInf(0),      SpoilerCollectionCheckGroup::GROUP_TWIN_ISLANDS);
