...
void LocationTable_Init() {
 ...
 locationTable[HMS_SONG_OF_HEALING]                                = ItemLocation::Base       (0x63, 0x54, false, "Song of Healing",                                          HMS_SONG_OF_HEALING,                            SONG_OF_HEALING,              {Category::cClockTower, Category::cDayOne},                                                                                SpoilerCollectionCheck::ItemGetInf(6),      SpoilerCollectionCheckGroup::GROUP_NO_GROUP);
 ...
 //Great Bay Coast
 locationTable[GBC_OCEAN_SPIDER_DAY1]                              = ItemLocation::Base       (0x28, 0x47, false, "OSH Day 1 Reward",                                         GBC_OCEAN_SPIDER_DAY1,                          PROGRESSIVE_WALLET,           {Category::cGreatBayCoast ,Category::cDayOne},                                                                             SpoilerCollectionCheck::ItemGetInf(0),      SpoilerCollectionCheckGroup::GROUP_GREAT_BAY_COAST );
 ...
 locationTable[ROAD_TO_SS_ARCHERY_1]                               = ItemLocation::Base       (0x24, 0x47, false,  "Road to Southern Swamp Archery 1",                         ROAD_TO_SS_ARCHERY_1,                           PROGRESSIVE_BOW,              {Category::cRoadToSouthernSwamp,Category::cMinigame,Category::cDayOne},                                                    SpoilerCollectionCheck::ItemGetInf(0),      SpoilerCollectionCheckGroup::GROUP_ROAD_SWAMP );
 ...
 locationTable[S_CLOCK_TOWN_BANK_REWARD_1]                         = ItemLocation::Base       (0x6F, 0x47, false, "SCT Bank Reward 1",                                        S_CLOCK_TOWN_BANK_REWARD_1,                     PROGRESSIVE_WALLET,           {Category::cSouthClockTown,Category::cDayOne},                                                                             SpoilerCollectionCheck::ItemGetInf(0),      SpoilerCollectionCheckGroup::GROUP_S_CLOCK_TOWN );
