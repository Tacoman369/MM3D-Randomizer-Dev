...
void LocationTable_Init() {
	...
	locationTable[E_CLOCK_TOWN_MAYOR]										   = ItemLocation::Base		  (0x12, 0x06, false, "E Clock Town Mayor Reward",						E_CLOCK_TOWN_MAYOR,					            PIECE_OF_HEART,				{Category::cEastClockTown, Category::cVanillaHeartPiece ,Category::cDayOne} );
	...
	locationTable[TERMINA_FIELD_BUSINESS_SCRUB]								   = ItemLocation::Base		  (0x07, 0x0C, false, "Termina Field Business Scrub",					TERMINA_FIELD_BUSINESS_SCRUB,		            PIECE_OF_HEART,				{Category::cTerminaField,Category::cGrotto,Category::cDekuScrub, Category::cVanillaHeartPiece,Category::cDayOne} );
